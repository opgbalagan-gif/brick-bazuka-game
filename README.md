...
- Ghost enemies suddenly appear about 260 pixels below the hero, briefly materialize, then charge toward the moving player at up to 540 pixels/second. Attacks begin after 2.5 seconds and recur every few seconds, becoming more frequent at greater heights. At most three attackers coexist; missed attacks expire after 4.5 seconds. Collision checks cover the traveled path so fast attacks and jet flight cannot pass through each other unnoticed.
